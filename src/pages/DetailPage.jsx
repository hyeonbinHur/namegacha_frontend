...
export default function DetailPage() {
  ...
  if (isLoading)
    return <img src={loading} alt="loading image" className="loading-sub" />;
  if (error) {
    navigate("/error");
  }
  return (
          ...
          <section className="detail--main">
            <ul className="detail--tab ul">
              <li className="detail--tab__li">
                ...
                />
                <label htmlFor="variable" className="detail--tab__label">
                  Variable
                </label>
              </li>
              <li className="detail--tab__li">
                <input
                  ...
                  className="detail--tab__radio"
                />
                <label htmlFor="function" className="detail--tab__label">
                  Function
                </label>
              </li>
            </ul>
